...
const page = () => {
  return (
    <div className="container mx-auto my-8 flex flex-col md:flex-row items-center bg-slate-300">
      <div className="md:w-1/2 mb-4 md:mb-0">
        {/* Contenido de texto */}
        <h1 className="text-3xl font-bold mb-6">Sobre Mí</h1>
        <p className="text-lg text-gray-700 mb-4">
          ¡Hola! Soy [Tu Nombre], un apasionado desarrollador web con experiencia en la creación de aplicaciones web atractivas y funcionales.
